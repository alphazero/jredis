...
/**
 * WIP NOTE: intended to replace existing pipeline per further tests.
 * 
 * [TODO: document me!]
 * 
...
public class ChunkedPipelineConnection 
	extends ConnectionBase // TODO: doesn't need the ThreadLocals -- rethink super via ConnectionSpec settings.
{
    ...
    static final int MTU_SIZE = 1024;
    private int off = 0;
...
//    }
    ...
    {
    	/* BUG ALERT -- WIP */
    	// NOTE: TODO: fix known bug with reqbuff > MTU ...
		...
		int		_reqbyteslen = -1;
		if(sendreq) {
			// this is already 1 byte[] allocs and 1 set of data write
			_reqbytes = protocol.createRequestBuffer(cmd, args);
			_reqbyteslen = _reqbytes.length;
		}
